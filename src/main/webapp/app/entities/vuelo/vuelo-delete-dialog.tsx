...
export const VueloDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="vueloDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-vuelo" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
